...
const Footer = () => {
    return (
        <div className="bg-black text-gray-200 py-4 px-6 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
            ...
            <p>&copy; {new Date().getFullYear()} FitLog. All rights reserved.</p>
        </div>
    );
};
